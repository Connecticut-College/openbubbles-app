...
class ThemeObject {
  ...
  List<ThemeEntry> toEntries() => [
        ...
        ThemeEntry.fromStyle(ThemeColors.Subtitle1, data!.textTheme.labelLarge!),
        ThemeEntry.fromStyle(ThemeColors.Subtitle2, data!.textTheme.labelMedium!),
        ...
        ThemeEntry(name: ThemeColors.BackgroundColor, color: data!.scaffoldBackgroundColor, isFont: false),
  ...
  ThemeData get themeData {
    ...
    return ThemeData(
        textTheme: TextTheme(
          ...
          labelLarge: data[ThemeColors.Subtitle1]!.style,
          labelMedium: data[ThemeColors.Subtitle2]!.style,
        ),
        ...
        scaffoldBackgroundColor: data[ThemeColors.BackgroundColor]!.style,
